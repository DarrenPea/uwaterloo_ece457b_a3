...
![cluster 3](img/q4/cluster3.png)  
From visually inspecting cluster 2 and 3 we can tell that Label 2 likely  corresponds to tops, cluster 2 shows mostly long sleeved crewnecks and hoodies, with 1 mislabeled bag, while cluster 3's images are women's dresses.

![cluster 1](img/q4/cluster1.png)  
![cluster 4](img/q4/cluster4.png)  
